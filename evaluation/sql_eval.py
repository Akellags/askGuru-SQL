...
对模型inference结果进行evaluation，currently supportsex、bird_ex、exec执行语法pass三种evaluation指标。
"""
import argparse
...
def args_paser():
    ...
    parser.add_argument('--pred_sql_path', type=str, required=True, default='/train/model/output/askgurusql_model/',
