...
大模型在测试数据上进行inference，get results，supports multiple concurrent approaches。
"""
...
def args_paser():
    ...
    parser.add_argument('--model_name_or_path', type=str, default='/train/model/output/askgurusql_model/',
    ...
    parser.add_argument('--expr_version', type=str, default='askguru_date', help='Experimental version as the saved name')
